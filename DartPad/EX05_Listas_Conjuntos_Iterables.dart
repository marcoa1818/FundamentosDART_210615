void main() {
  ...
  //La declaracion de una list estra limitada por corchetes (brackets) y cada elemento de ser individual y puede repetirse.
  ...
  print("El tamaño es: ${numeros.length}");
  print("""
 ...
 // Iterables
  ...
  print(
      "Los iterables son estructuradas de datos que DART y otros lenguajes para optimizar en termino de velocidad el acceso a los datos y propiedades");
...
Podemos visualizar en el resultado que el SET a eliminado los duplicados y ahora delimita datos usando {}""");
